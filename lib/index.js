...
const Main = ({ theme, translation: trIn, withAlphaFilter, ...props }) => {
    const translation = (trIn && trIn.toLowerCase());
    if (props.withLetterScroller === undefined) {
        props.withLetterScroller = withAlphaFilter;
    }
